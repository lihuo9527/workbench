function window_obj() {
    ...
    window_obj.prototype.ip = function() {
        ...
        // return window.myjs ? window.myjs.getIp() : "http://192.168.11.120:9999";
    ...
    window_obj.prototype.defaultCompany = function() {
        return window.myjs ? window.myjs.defaultCompany() : "2";
    }
    window_obj.prototype.typeCode = function() {
        return window.myjs ? window.myjs.typeCode() : "customor";
    }
}