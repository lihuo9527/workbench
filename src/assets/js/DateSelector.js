    ...
    DateSelector.prototype = {
        ...
        initDomFuc: function() {
            ...
            html += '<div class="date-selector-bg" id="date-selector-bg-' + _this.container + '">' +
                ...
                '<p class="date-selector-btn" id="date-selector-btn-cancel">返回</p>';

            if (this.type == 1) {
                html += '<p class="date-selector-btn">' +
            ...
            html += '<p class="date-selector-btn" id="date-selector-btn-save-' + _this.container + '">确定</p>' +
                '</div>' +
